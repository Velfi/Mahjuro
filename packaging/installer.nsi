...
Section "Mahjuro" SecMain
  ...
  File "${SOURCE_DIR}\mahjuro-pack-essential.zip"
  File "${SOURCE_DIR}\mahjuro-pack-gameplay.zip"
  File "${SOURCE_DIR}\mahjuro-pack-audio.zip"
...
Section "Uninstall"
  ...
  Delete "$INSTDIR\mahjuro-pack-essential.zip"
  Delete "$INSTDIR\mahjuro-pack-gameplay.zip"
  Delete "$INSTDIR\mahjuro-pack-audio.zip"
