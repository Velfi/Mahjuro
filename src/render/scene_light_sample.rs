...
use crate::render::draw_cmd::{CameraParams, ScenePunctualLight};
use crate::render::room_env_gltf::RoomCollisionMesh;
use crate::render::wgpu_renderer::{PointLight, SpotLight};
use crate::render::world_space::{pixel_to_world, world_on_camera_ray_plane_z};
...
impl PunctualOccluderAabb {
    /// Largest room collision volumes first, capped at [`crate::render::wgpu_renderer::MAX_TILE_OCCLUDERS`].
    pub fn from_room_collision_meshes(
        ...
        ranked
            .into_iter()
            .take(crate::render::wgpu_renderer::MAX_TILE_OCCLUDERS)
            .map(|(_, o)| o)
            .collect()
    }
}
