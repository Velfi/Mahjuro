...
use crate::render::particles::RainSpawnVolume;
use crate::render::rain_field::main_menu_rain_spawn_volume;
...
impl RainDebugOverlay {
    ...
    pub fn draw(
        ...
        let volume = main_menu_rain_spawn_volume(env_scale, window_h, &self.tuning);
