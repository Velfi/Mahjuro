...
pub fn build_shrine_mesh() -> MeshCpu {
    ...
    push_box(
        &mut vertices,
        &mut indices,
        Aabb::new(-0.50, 0.50, -0.50, -0.36, -0.40, 0.40),
    );
    ...
    push_box(
        &mut vertices,
        &mut indices,
        Aabb::new(-0.42, 0.42, -0.36, -0.28, -0.34, 0.34),
    );
    ...
    push_box(
        &mut vertices,
        &mut indices,
        Aabb::new(-0.16, 0.16, -0.28, 0.18, -0.16, 0.16),
    );
    ...
    push_box(
        &mut vertices,
        &mut indices,
        Aabb::new(-0.28, 0.28, 0.18, 0.26, -0.24, 0.24),
    );
    ...
    push_box(
        &mut vertices,
        &mut indices,
        Aabb::new(-0.24, 0.24, 0.26, 0.30, -0.22, 0.22),
    );
    ...
    push_box(
        &mut vertices,
        &mut indices,
        Aabb::new(-0.46, 0.46, 0.36, 0.44, -0.36, 0.36),
    );
    ...
    push_box(
        &mut vertices,
        &mut indices,
        Aabb::new(-0.10, 0.10, 0.44, 0.50, -0.36, 0.36),
    );
    ...
    push_box(
        &mut vertices,
        &mut indices,
        Aabb::new(-0.06, 0.06, 0.30, 0.36, -0.30, -0.24),
    );
    push_box(
        &mut vertices,
        &mut indices,
        Aabb::new(-0.06, 0.06, 0.30, 0.36, 0.24, 0.30),
    );
