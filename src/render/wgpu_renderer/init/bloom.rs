...
pub fn build_bloom(
    ...
    let (bloom_ping_texture, bloom_ping_view) = crate::render::wgpu_renderer::resources::create_post_texture(
        device,
        scene_hdr_format,
        bloom_w,
        bloom_h,
    ...
    let (bloom_pong_texture, bloom_pong_view) = crate::render::wgpu_renderer::resources::create_post_texture(
        device,
        scene_hdr_format,
        bloom_w,
        bloom_h,
