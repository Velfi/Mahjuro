...
pub fn bot_aggregate_from(a: &AggregateStats) -> BotAggregate {
    BotAggregate {
        sums: AggregateSums {
            ...
            total_yen_spent: a.total_yen_spent,
            total_final_yen: a.total_final_yen,
            total_yen_from_clears: a.total_yen_from_clears,
            total_yen_from_clear_base: a.total_yen_from_clear_base,
            ...
            total_yen_clear_green_luck: a.total_yen_clear_green_luck,
            total_yen_clear_gold_idol: a.total_yen_clear_gold_idol,
            total_yen_clear_jade_abacus: a.total_yen_clear_jade_abacus,
            total_yen_clear_patience: a.total_yen_clear_patience,
...
pub fn derived_from_batch(
    ...
    let per_run = PerRunAverages {
        ...
        yen_spent: a.total_yen_spent as f64 / r,
        yen_from_clears: a.total_yen_from_clears as f64 / r,
        yen_per_chamber_cleared: if a.chambers_cleared_total == 0 {
            0.0
        } else {
            a.total_yen_from_clears as f64 / a.chambers_cleared_total as f64
        },
        ...
        yen_clear_relics: a.total_yen_from_clear_relics as f64 / r,
        yen_clear_green_luck: a.total_yen_clear_green_luck as f64 / r,
        yen_clear_gold_idol: a.total_yen_clear_gold_idol as f64 / r,
        yen_clear_jade_abacus: a.total_yen_clear_jade_abacus as f64 / r,
        yen_clear_patience: a.total_yen_clear_patience as f64 / r,
        ...
        final_yen: a.total_final_yen as f64 / r,
