...
impl crate::sfx_id::SfxId {
    pub(crate) fn filename(self) -> &'static str {
        match self {
            ...
            SfxId::YakuShousangen => "yaku/full_hand.ogg",
            SfxId::YakuDaisangen => "yaku/yakuhai.ogg",
            ...
            SfxId::Times2 => "sfx/times_2.ogg",
            SfxId::Times3 => "sfx/times_3.ogg",
            SfxId::Times4 => "sfx/times_4.ogg",
