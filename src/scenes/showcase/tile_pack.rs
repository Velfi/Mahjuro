...
use super::super::{
    BackgroundId, ButtonDef, DrawCtx, OverlayRequest, SceneTransition, UpdateCtx,
};
...
impl TilePackPresenter {
    ...
    pub fn draw_frame(&self, ctx: DrawCtx<'_>) -> UiFrame {
        ...
        frame.scene_lighting.set_smooth_points(pack_celebration_isolation_lights(
...
fn pack_celebration_subject_spotlight(
    ...
    match celeb.phase {
        ...
        CelebPhase::Reveal => {
            ...
            let total_w = n as f32 * row.silhouette_w
                + (n.saturating_sub(1)) as f32 * row.gap_px;
