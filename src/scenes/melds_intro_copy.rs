//! Shared copy for the Guide melds page (tile-shape examples).

pub const PAGE_TITLE: &str = "Melds";

pub const PAGE_SUBTITLE: &str =
    "Melds are small tile groups — pairs, sequences, triplets, and kongs. Valid melds can be played into your structure.";
