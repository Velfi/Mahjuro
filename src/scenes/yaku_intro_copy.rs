...
pub const PAGE_SUBTITLE: &str = "Play valid melds into your structure, then Cash In to score. Yaku are bonus patterns in your structure — they add Fu and Han when you Cash In.";
...
pub const CASH_IN_LINES: &[&str] = &[
    ...
    "Score equals Fu × Han — modified by tiles, yaku, relics, and bosses.",
