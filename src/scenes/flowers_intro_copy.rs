...
pub const INTRO_LINE_1: &str = "Flowers are wildcards — they can replace one tile in a three-tile meld.";
pub const INTRO_LINE_2: &str = "Flowers are useful for forming yaku, but this comes at a cost: they don't contribute to a meld's score.";
