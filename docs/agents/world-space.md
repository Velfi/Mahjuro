...
For how screen placement, [`Placement`](../../src/ui/placement.rs), and arrange mode fit together, see [scene-placement](scene-placement.md). Note: [`PlacementAnchor`](../../src/render/world_space.rs) here is the score-reel / HUD helper — different from [`ui::placement::PlacementAnchor`](../../src/ui/placement.rs) used with saved `Placement`s.
