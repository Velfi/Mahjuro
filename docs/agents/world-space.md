...
[`ui::placement::PlacementAnchor`](../../src/ui/placement.rs) composes layout **degrees** into [`Object3d`](../../src/render/draw_cmd.rs) rotation via `object3d_rotation` — do not mix these Euler values with raw `Object3d` euler fields; pick one recipe per draw path.

**Name collision:** [`PlacementAnchor`](../../src/render/world_space.rs) in `world_space.rs` is the score-reel / HUD helper — different from [`ui::placement::PlacementAnchor`](../../src/ui/placement.rs).
