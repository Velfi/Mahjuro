...
//!
//! Asset-local frames map into this space via [`crate::table_transform`] — e.g.
//! [`crate::table_transform::tile_mesh_local_to_world`],
//! [`crate::table_transform::mesh_y_thickness_along_local_y_to_z_up`]. Lit meshes use
//! [`crate::table_transform::translate_rot_scale`] with world-space centers.
//!
//! [`DrawCmd`](crate::draw_cmd) packs `(px, py, lift)` into [`WorldSurfaceAnchor`](crate::draw_cmd::WorldSurfaceAnchor);
...
/// Inverse of [`pixel_to_world`] — packs world XYZ into [`crate::draw_cmd::Object3d::pos`] anchor form.
#[inline]
...
/// [`crate::wgpu_renderer::runtime::camera::CameraFrame::build`].
...
/// Encode a world-space mesh center into `[px, py, lift]` for [`crate::draw_cmd::Object3d::pos`]
...
/// Layout-space anchor (pixels + lift) before packing into [`WorldSurfaceAnchor`](crate::draw_cmd::WorldSurfaceAnchor).
...
impl LayoutAnchorPx {
    /// Packed `[px, py, lift]` for [`crate::draw_cmd`] placement structs.
    #[inline]
