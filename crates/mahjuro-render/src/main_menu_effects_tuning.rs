    ...
    pub fn to_rust_literal(self) -> String {
        format!(
            concat!(
                ...
                "        far_color: [{:.4}, {:.4}, {:.4}], far_brightness: {:.4},\n",
                "        gradient_near_heights: {:.4}, gradient_far_heights: {:.4},\n",
                "    }},\n",
                "    moon: MainMenuMoonTuning {{\n",
            ...
            self.fog.color[2],
            self.fog.brightness,
            self.fog.far_color[0],
            self.fog.far_color[1],
            self.fog.far_color[2],
            self.fog.far_brightness,
            self.fog.gradient_near_heights,
            self.fog.gradient_far_heights,
