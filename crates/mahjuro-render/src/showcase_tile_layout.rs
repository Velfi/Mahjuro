//! Screen-space layout helpers for [`crate::draw_cmd::ShowcaseTilePlacement`] rows.
//! Matches model construction in [`crate::wgpu_renderer::runtime::showcase_tiles`].
...
/// Upper cap on [`crate::draw_cmd::ShowcaseTilePlacement::size_px`] vs window height.
...
mod tests {
    ...
    fn pack_reveal_row_tiles_are_readable_on_celebration_camera() {
        let w = 1920.0_f32;
        let h = 1080.0_f32;
        let cam = shop_celebration_camera(w, h, crate::room_glb::SHOP_ENV_HEIGHT_SCALE);
