...
impl WgpuRenderer {
    ...
    pub(super) fn seed_gameplay_action_pick_proxies(
        &mut self,
        camera: &CameraFrame,
        picks: &crate::draw_cmd::GameplayActionPickProxies,
    ) {
    ...
    pub(super) fn run_object3d_placement(
        ...
        camera: &CameraFrame,
        object3d_cmds: &[&[crate::draw_cmd::Object3d]],
        ...
        // Also fills in the start/end range in the corresponding RenderOp.
        {
            ...
            let mut obj3d_primitive_slot: rustc_hash::FxHashMap<crate::primitive::MeshId, usize> =
                    ...
                    match &obj.kind {
                        ...
                        Object3dKind::YakuTablet {
                            ...
                            if inst.decal_texture.is_none() || inst.decal_label_hash != label_hash {
                                let rgba = crate::decal::rasterize_yaku_tablet_decal(
                                    label,
                                    self.ui_font.as_ref(),
                        ...
                        Object3dKind::Book {
                            ...
                            let spine_x = crate::book_mesh::SPINE_X;
                            let cover_y_mid = 0.5
                                * (crate::book_mesh::FRONT_COVER_Y_LO
                                    + crate::book_mesh::FRONT_COVER_Y_HI);
                        ...
                        Object3dKind::Relic {
                            ...
                            let material = if *silhouette {
                                crate::lit_mesh::MaterialParams {
                                    kind: crate::lit_mesh::MaterialKind::Plain,
                                    base_color,
                        ...
                        Object3dKind::Talisman { .. } | Object3dKind::MemorialTalisman { .. } => {
                            ...
                            let (material, kind_idx, height_view, mask_view) = match &obj.kind {
                                Object3dKind::Talisman { kind } => {
                                    let idx = mahjuro_core::core::talisman::TalismanKind::all()
                                        .iter()
                                        .position(|&k| k == *kind)
                                        .unwrap_or(0)
                                        as u8;
                        ...
                        Object3dKind::Bug {
                            ...
                            let slot = *slot;
                            if slot >= crate::wgpu_renderer::MAX_BUG_SLOTS {
                                continue;
                            }
                        ...
                        Object3dKind::ExtrudedGlyph {
                            ...
                            let material = match g_mat {
                                crate::draw_cmd::GlyphMaterial::Metal => MaterialParams {
                                    kind: MaterialKind::Metal,
                                    base_color: obj.color,
                                    specular_strength: 1.0,
                                    specular_power: 128.0,
                                },
                                crate::draw_cmd::GlyphMaterial::Polychrome => MaterialParams {
                            ...
                            let halo_strength =
                                if matches!(g_mat, crate::draw_cmd::GlyphMaterial::Polychrome)
                                    && *emissive > 0.65
                                {
                        ...
                        Object3dKind::TallyFan {
                            ...
                            for &k in visible_slots.iter() {
                                ...
                                let model = crate::table_transform::apply_rotation_deg_to_model(
