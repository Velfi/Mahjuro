...
pub(super) fn build_renderer_new(
    ...
    let (main_menu_env_primitives, main_menu_environment, main_menu_moon_prim_indices) =
        (Vec::new(), None, Vec::new());
    ...
    Ok(WgpuRenderer {
        ...
        tile_shadow_frame_uniform_buffer,
        tile_shadow_frame_bind_group,
        tile_3d_instances_staging: Vec::new(),
        tile_3d_batch_ranges: Vec::new(),
        tile_3d_batch_blend_ranges: Vec::new(),
        tile_shadow_instances_staging: Vec::new(),
