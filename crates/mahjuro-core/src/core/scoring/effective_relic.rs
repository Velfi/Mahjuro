...
impl EffectiveRelics {
    ...
    pub fn from_roster(roster: &RelicState) -> Self {
    ...
    #[inline]
    pub fn has(self, relics: &RelicState, id: RelicId) -> bool {
        relics.has(id) || self.mirrored == Some(id) || self.shadowed == Some(id)
    }

    #[inline]
    pub fn count(self, relics: &RelicState, id: RelicId) -> u32 {
